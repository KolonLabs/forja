...
- Relato recibe una allowlist de skills comunes: `mecanica-prosa` y solo los estilos activos. Todo contrato de guion, ficha, contexto o validación procede de `shared/pipelines/relato/skills/`.
