...
| DT-004 | El modelo de relato con beats globales y escenas operativas no dispone aún de una prueba de regresión automatizada con recurrencias `[D]`, anclas invisibles, salidas continuas/separadores, commit recuperable, corrección estructural y edición derivada legacy. | Una modificación futura puede reintroducir IDs sin materializar, skills de novela, headings por beat, publicación o agrupaciones incompatibles sin detectarse antes de crear workspaces. | Crear un fixture aislado y comprobar IDs H/B/E únicos, allowlist de skills, creación y cierre de `cola_d.md`, correspondencia guion/escenas/anclas de draft, confirmación y recuperación del staging, publicación de salidas, transiciones de estado, regeneración del contexto y migración segura de una edición derivada. |
