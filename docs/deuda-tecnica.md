...
| DT-004 | El modelo de relato con beats globales y escenas operativas no dispone aún de una prueba de regresión con recurrencias `[D]`, anclas invisibles, salidas continuas/separadores, corrección estructural y edición derivada. | Una modificación futura puede reintroducir IDs sin materializar, skills de novela, headings por beat, publicación o agrupaciones incompatibles sin detectarse antes de crear workspaces. | Crear un fixture aislado y comprobar IDs H/B/E únicos, allowlist de skills, correspondencia guion/anclas de draft, publicación de salidas, transiciones de estado y regeneración del contexto desde una escena corregida. |
