...
| DT-004 | El modelo de relato con beats globales y escenas operativas no dispone aún de una prueba de regresión con recurrencias `[D]`, salidas continuas/separadores, corrección estructural y edición derivada. | Una modificación futura puede reintroducir encabezados, publicación o agrupaciones incompatibles sin detectarse antes de crear workspaces. | Crear un fixture aislado y comprobar IDs únicos, correspondencia guion/draft, publicación de salidas, transiciones de estado y regeneración del contexto desde una escena corregida. |
