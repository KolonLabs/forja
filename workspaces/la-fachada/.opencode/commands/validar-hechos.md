...
3. **Separa hechos lineales y `[D]`.** La validación de coherencia aplica a AMBOS, pero los `[D]` tienen criterios específicos adicionales por ser patrones que se despliegan en el tiempo.
