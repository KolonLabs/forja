...
3. **`plantilla-lugar`** (skill) — Estructura para descripción de lugares (reemplaza la antigua `plantilla-escenario`)
...
- **Máximo 2 frases**: si necesitas una tercera, estás haciendo trabajo del escritor
